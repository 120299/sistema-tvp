      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('Vender productos'),
            onTap: () {
          ...
          ListTile(
            ...
            subtitle: const Text('Gestionar mesas'),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            subtitle: const Text('Catálogo de productos'),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            subtitle: const Text('Estadísticas y ventas'),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            subtitle: const Text('Administrar datos guardados'),
            onTap: () {
              Navigator.pop(context);
              _showDataManager(context);
            },
          ...
          ListTile(
            ...
            subtitle: const Text('Datos del negocio'),
            onTap: () {
              Navigator.pop(context);
              Navigator.pushNamed(context, '/configuracion');
            },
          ...
          ListTile(
            ...
            onTap: () {
              ...
              showAboutDialog(
                ...
                children: const [
                  Text('Sistema profesional de Terminal Punto de Venta.'),
                  SizedBox(height: 8),
                  Text(
                    'Cumple con el Real Decreto 1496/2003 sobre facturación.',
